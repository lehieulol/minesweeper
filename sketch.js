let board = [], t_t = [];
let mode = 'de', sizeX = 10, sizeY = 25, bom = 25, size, tt = 0;
...
function setup() {
	...
	de.position(240,70);
	de.size(70,20);
	de.mouseClicked(function(){mode = 'de';sizeX = 10; sizeY = 25;bom = 25; makeboard()});
	vua = createButton('Pupil');
	vua.position(320,70);
	vua.size(70,20);
	vua.mouseClicked(function(){mode = 'vua';sizeX = 20; sizeY = 50;bom = 120; makeboard()});
	kho = createButton('Expert');
	kho.position(400,70);
	kho.size(70,20);
	kho.mouseClicked(function(){mode = 'kho';sizeX = 40; sizeY = 100;bom = 500; makeboard()});
	makeboard();
}
